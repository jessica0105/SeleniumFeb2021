...
public class PeticionVacaciones extends Base{
	...
	public void pedirVacacionesCorrectamente() throws Exception {
		...
		page.getPage(AssignLeave.class).pedirVacacionesValidas("Orange Test", "US - Personal", "2021-04-17", "2021-04-17", "Full Day", "Comentario", "Employee does not have sufficient leave balance for leave request.");
